<x-app-layout>
    ...
    <div class="max-w-2xl">
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            <form method="POST" action="{{ route('zones.store') }}" class="p-6">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input type="text"
                           ...
                           placeholder="Ex: Terrasse, VIP, Salle principale..."
                           required
                           autofocus>
                    @error('nom')
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description"
                              ...
                              rows="3"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-colors"
                              placeholder="Description de la zone...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>

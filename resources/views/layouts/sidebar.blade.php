            ...
            <div class="mb-6">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <a href="{{ route('parametres.index') }}"
                       class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('parametres.*') || request()->routeIs('users.*') ? 'bg-primary-500 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">

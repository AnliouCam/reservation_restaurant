<x-app-layout>
    ...
    <div class="max-w-2xl">
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            <form method="POST" action="{{ route('tables.store') }}" class="p-6">
                @csrf
                ...
                <div class="mt-6">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <label class="flex items-center">
                            <input type="radio" name="statut" value="disponible" {{ old('statut', 'disponible') === 'disponible' ? 'checked' : '' }}
                        ...
                        <label class="flex items-center">
                            <input type="radio" name="statut" value="reservee" {{ old('statut') === 'reservee' ? 'checked' : '' }}
                        ...
                        <label class="flex items-center">
                            <input type="radio" name="statut" value="occupee" {{ old('statut') === 'occupee' ? 'checked' : '' }}
